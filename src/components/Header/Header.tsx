        ...
        <div className=" bottom-0 left-0 flex h-30 md:h-48 w-full items-end justify-center  lg:static lg:h-auto lg:w-auto lg:bg-none">
          ...
          >
            <div className="flex flex-col text-center">
              <h1 className="text-base text-xl uppercase lgtext-3xl text-sky-400/100 font-semibold	">
                {sitename}
              </h1>
              <p className="font-xl m-2 text-slate-800 dark:text-slate-100 font-light">
                {sitetagline}
              </p>
            </div>
          </a>
