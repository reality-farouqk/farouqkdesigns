...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="bg-cover bg-center p-8 bg-[#42AFC0] px-5 py-24 md:px-12">
      ...
      <div className="flex justify-center">
        <form className="bg-white p-8 rounded shadow-lg w-full max-w-2xl" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-center">
            <button
              className={`bg-[#D41E00] hover:bg-[#550C00] text-white uppercase text-bold text-sm py-3 px-4 rounded focus:outline-none focus:shadow-outline ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
              type="submit"
              disabled={loading}
            >
